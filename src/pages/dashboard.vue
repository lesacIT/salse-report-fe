<script setup>
import AcademyAssignmentProgress from '@/views/app/academy/AcademyAssignmentProgress.vue'
import AcademyCardPopularInstructors from '@/views/app/academy/AcademyCardPopularInstructors.vue'
import AcademyCardTopCourses from '@/views/app/academy/AcademyCardTopCourses.vue'
import AcademyCourseTable from '@/views/app/academy/AcademyCourseTable.vue'
import AcademyUpcomingWebinar from '@/views/app/academy/AcademyUpcomingWebinar.vue'
