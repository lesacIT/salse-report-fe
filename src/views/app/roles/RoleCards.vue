        ...
        <VCardText class="d-flex align-center pb-1">
          ...
          <div class="v-avatar-group">
            <template v-for="user in item.users ">
              <!-- <VImg  size="36" :src="'http://127.0.0.1:8000/storage/'+user2" /> -->
              ...
              <VImg
                ...
                :src="Url+'storage/'+ user.avatar"
              />
              <!-- <img  :src="'http://127.0.0.1:8000/storage/images/avatars/667bc455186f5.jpg'" alt="Downloaded Image" /> -->
            </template>

            <!-- Display count of remaining users if there are more than 4 users -->
            <VAvatar
